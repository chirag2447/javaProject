...
public interface AdminSessionBeanLocal {
    ...
    void addProduct(String name, int brand, String image, String price, int color, int size, int category);

    void deleteProduct(int id);

    Product searchProduct(int id);

    void updateProduct(int id, String name, int brand, int color, int size, String image, int category, String price);

    void addImage(String image, int product_id, int color_id);
