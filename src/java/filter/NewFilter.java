...
public class NewFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
            ...
            if(req.getParameter("username")!=null){
                ...
                AuthenticationStatus status = ctx.authenticate(req, res, AuthenticationParameters.withParams().credential(credential) );
...
res.sendRedirect("../Admin/index.jsf");
                            }else if(ctx.isCallerInRole("User")){
                            
//                                    req.getRequestDispatcher("home.jsf").forward(req, res);
                    ...
                    req.setAttribute("error", "your username or password maybe wrong!!!!!!");
                    req.setCharacterEncoding("UTF-8");
                    req.getRequestDispatcher("login-reg/login.jsf").forward(req, res);
                }
            }
